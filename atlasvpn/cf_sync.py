...
from atlasvpn.cf_credentials import (
...
from atlasvpn.paths import TUNNELS_JSON
...
def preflight_api_token(api_token: str, account_id: str) -> None:
    ...
    ayuda = (
        ...
        "• Si editaste .atlasvpn/settings.json a mano, valida JSON; mejor pegar desde la app.\n"
